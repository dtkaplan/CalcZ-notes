...
$$\require{cancel}\partial_x \left[\strut f(x) g(x) \right] \equiv \frac{f(x+h) g(x+h) - f(x) g(x)}{h}$$
...
`r insert_calcZ_exercise("22.06", "qyOuQF", "Exercises/Diff/giraffe-sit-piano.Rmd")`

`r insert_calcZ_exercise("22.08", "yT2BkB", "Exercises/Diff/ant-bite-bed.Rmd")`

`r insert_calcZ_exercise("22.10", "Z7MY4I", "Exercises/Diff/goat-pay-pantry.Rmd")`

`r insert_calcZ_exercise(22.12, "QIELS", "Exercises/Diff/dnorm.Rmd")`

`r insert_calcZ_exercise(22.14, "HCILW", "Exercises/Diff/descent-path.Rmd")`

`r insert_calcZ_exercise("22.16", "ed6q4v", "Exercises/Diff/goldfish-keep-bed.Rmd")`
