...
`r insert_calcZ_exercise("21.08", "ed6q4v", "Exercises/Diff/goldfish-keep-bed.Rmd")`
...
`r insert_calcZ_exercise("21.10", "qyOuQF", "Exercises/Diff/giraffe-sit-piano.Rmd")`

`r insert_calcZ_exercise("21.12", "yT2BkB", "Exercises/Diff/ant-bite-bed.Rmd")`

`r insert_calcZ_exercise("21.14", "Z7MY4I", "Exercises/Diff/goat-pay-pantry.Rmd")`
...
`r insert_calcZ_exercise(21.16, "QIELS", "Exercises/Diff/dnorm.Rmd")`


-----

`r insert_calcZ_exercise(21.18, "HCILW", "Exercises/Diff/descent-path.Rmd")`
...
### Step 1: Identify f() and g() {.unnumbered}
...
`r insert_calcZ_exercise("21.20", "3ICCCz", "Exercises/Diff/lamb-rise-sofa.Rmd")`

`r insert_calcZ_exercise("21.22", "QFzIOl", "Exercises/Diff/buck-draw-bed.Rmd")`

### Step 2: Find f'() and g'() {.unnumbered}
...
`r insert_calcZ_exercise("21.24", "jYXYTF", "Exercises/Diff/ant-give-room.Rmd")`

### Step 3: Apply the relevant rule{.unnumbered}
