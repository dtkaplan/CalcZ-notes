...
Three of the pattern-book functions---$1/x$, $x$, $x^2$---belong to a infinite family called the ***power-law functions***.  Some other examples of power-law functions are $x^3, x^4, \ldots$ as well as $x^{1/2}$ (also written $\sqrt{x}$), $x^{1.36}$, and so on. All of these can be written $x^p$, where $p$ is a number. `r mark(290)`
...
`r insert_calcZ_exercise(2.1, "H2eu2", "Exercises/Fun/pattern-book-descriptions.Rmd")`
...
`r insert_calcZ_exercise(2.3, "PYKG5", "Exercises/Fun/pattern-book-concave.Rmd")`
