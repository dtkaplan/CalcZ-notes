...
From your experience with highways, you know the connection will be a ***smooth*** curve. If the curve is part of a circle, then the design needs to specify the ***radius of curvature*** of the circle. Too tight a radius and the traffic won't be able to handle the centrifugal force and will drift or skid off the road. A big radius is needed for safety, but making the radius bigger than required for safety adds additional cost to road construction.
...
`r insert_calcZ_exercise("20.1", "ykIBCb", "Exercises/Diff/frog-bid-bed.Rmd")`

`r insert_calcZ_exercise("20.2", "QnpuMN", "Exercises/Diff/turtle-send-pot.Rmd")`

`r insert_calcZ_exercise("20.3", "kq3t86", "Exercises/Diff/reptile-put-kitchen.Rmd")`

`r insert_calcZ_exercise("20.4", "BVRjhF", "Exercises/Diff/goat-pay-pot.Rmd")`

`r insert_calcZ_exercise("20.5", "5ddB5r", "Exercises/Diff/seahorse-speak-saucer.Rmd")`

`r insert_calcZ_exercise("20.6", "4nsU0z", "Exercises/Diff/panda-drive-shirt.Rmd")`

`r insert_calcZ_exercise("20.7", "iIXOYZ", "Exercises/Diff/crow-write-chair.Rmd")`

`r insert_calcZ_exercise("20.8", "bHacc6", "Exercises/Diff/goat-come-bed.Rmd")`

`r insert_calcZ_exercise("20.9", "jyXhPM", "Exercises/Diff/chicken-sleep-knife.Rmd")`

<!-- `rrr insert_calcZ_exercise("XX.XX", "v2doBq", "Exercises/Diff/boy-send-book.Rmd")` -->

`r insert_calcZ_exercise("20.10", "rou0yO", "Exercises/Diff/tiger-blow-futon.Rmd")`
