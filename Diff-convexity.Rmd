...
`r insert_calcZ_exercise("19.1", "ykIBCb", "Exercises/Diff/frog-bid-bed.Rmd")`


`r insert_calcZ_exercise("19.2", "QnpuMN", "Exercises/Diff/turtle-send-pot.Rmd")`


`r insert_calcZ_exercise("19.3", "kq3t86", "Exercises/Diff/reptile-put-kitchen.Rmd")`

`r insert_calcZ_exercise("19.4", "BVRjhF", "Exercises/Diff/goat-pay-pot.Rmd")`
...
`r insert_calcZ_exercise("19.5", "5ddB5r", "Exercises/Diff/seahorse-speak-saucer.Rmd")`

`r insert_calcZ_exercise("19.6", "4nsU0z", "Exercises/Diff/panda-drive-shirt.Rmd")`
...
`r insert_calcZ_exercise("19.7", "iIXOYZ", "Exercises/Diff/crow-write-chair.Rmd")`
...
`r insert_calcZ_exercise("19.8", "jyXhPM", "Exercises/Diff/chicken-sleep-knife.Rmd")`
...
`r insert_calcZ_exercise("19.9", "bHacc6", "Exercises/Diff/goat-come-bed.Rmd")`

`r insert_calcZ_exercise("19.10", "rou0yO", "Exercises/Diff/tiger-blow-futon.Rmd")`
