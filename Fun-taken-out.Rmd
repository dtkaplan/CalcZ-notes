...
```{exercise, name="chicken-choose-vase"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child(exercise_file("05", "chicken-choose-vase.Rmd"))`</details>

```{exercise, name="cow-type-kayak-new"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child(exercise_file("05", "cow-type-kayak-new.Rmd"))`</details>
