...
`r insert_calcZ_exercise("XX.XX", "9sles", exercise_file("05", "chicken-choose-vase.Rmd"))`

`r insert_calcZ_exercise("XX.XX", "3sdwB", exercise_file("05", "cow-type-kayak-new.Rmd"))`
