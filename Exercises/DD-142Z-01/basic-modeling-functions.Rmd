...
We will continue to focus on these basic modeling functions because 1) they are useful and 2) their anti-derivatives are so simple that you should learn to write them in math notation from memory. (We're leaving out hump & sigmoid functions because their algebra is not so generally useful. But remember that the derivative of a sigmoid is a hump function.)
