...
Evaluate the following commands in a `r sandbox_link()` to calculate the first two of the sum formulas with $dt = 0.01$ hour and $dt = 0.001$ hour respectivly. (The function $\mbox{vel}(t)$ is given as `vel()`.)
