...
```
$$\huge \int_\color{tan}{a}^\color{tan}{b} \color{red}{f(x)} dx = \color{blue}{F(x)}\left.\right|_\color{tan}{a}^\color{tan}{b} = \color{blue}{F(\color{tan}{b})} -\color{blue}{F(\color{tan}{a})}$$
