...
In an earlier exercise, we considered a graphic from the [US Centers for Disease Control](https://www.cdc.gov/nchs/nvss/vsrr/covid19/excess_deaths.htm) in early December 2020. It shows deaths as a function of time of year.

```{r echo=FALSE}
knitr::include_graphics("www/US-deaths.png")
```

In that earlier exercise, we observed that the total number of deaths corresponds to the "area" under the curve, that is, the integral of the graphed function over the relevant time span.

In this exercise, you'll estimate the number of "excess deaths" in 2020 compared to previous years. Presumably, these excess deaths are related, directly or indirectly, to COVID-19.

Since there is data for 2020 only through October, our estimate will cover only that period.
