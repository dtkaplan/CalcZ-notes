...
```{r daily-digital-07-QA1, echo=FALSE}
etude2::etudeQ(
...
```{r daily-digital-07-QA2, echo=FALSE}
etude2::etudeQ(
...
```{r daily-digital-07-QA3, echo=FALSE}
etude2::etudeQ(
...
```{r daily-digital-07-QA4, echo=FALSE}
etude2::etudeQ(
...
gf_point(Minutes ~ Month, data = SunsetLA) %>%
  ...
  slice_plot(guessed_fun(Month) ~ Month,  color = "red")
