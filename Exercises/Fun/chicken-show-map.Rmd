...
askMC(
  prompt = "MMAC 4.1.61: True or false: The average rate of change of $f(x) \\equiv e^{x^2}$ over [0.0, 0.1] is 0.1005017",
  "+TRUE+",
  "FALSE",
  random_answer_order = FALSE)
```
...
askMC(
  prompt = "MMAC 4.1.62: True or false: The average rate of change of $f(x) \\equiv \\log(x)$ over [2, 3] is 0.5062353.  
...
askMC(
  prompt = "MMAC 4.1.61: True or false: The average rate of change of $f(x) \\equiv \\sin(x)$ over [0.0, 0.5] is 0.9588511",
  "+TRUE+",
  "FALSE",
  random_answer_order = FALSE)
```
