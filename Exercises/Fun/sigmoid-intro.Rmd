...
slice_plot(pnorm(x, mean = 5, sd = 3) ~ x, domain(x=c(-5,15)),
           label_text = "sigmoid") %>%
  slice_plot(dnorm(x, mean = 5, sd = 3) ~ x, color = "blue",  label_text = "gaussian") %>%
  gf_labs(title  = "(A)")
```
...
slice_plot(pnorm(x, mean = 4, sd = 3) ~ x, domain(x=c(-5,15)),
           label_text = "sigmoid") %>%
  slice_plot(dnorm(x, mean = 2, sd = 1) ~ x, color = "blue",  label_text = "gaussian") %>%
  gf_labs(title = "(B)")
```
...
slice_plot(pnorm(-x, mean = -5, sd = 3) ~ x, domain(x=c(-5,15)),
           label_text = "sigmoid") %>%
  slice_plot(-dnorm(x, mean = 5, sd = 3) ~ x, color = "blue",  label_text = "gaussian", label_x = 0.1) %>%
  gf_labs(title  = "(C)")
```
