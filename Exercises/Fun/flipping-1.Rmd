...
askMC(
  ...
  "+black+", "dodgerblue", "green", "orange3", "none of them", random_answer_order=FALSE
  )
```
...
askMC(
  ...
  "black", "dodgerblue", "green", "+red+", "none of them", random_answer_order=FALSE
)
```
...
askMC(
  ...
  "black", "+blue+", "green", "orange3", "none of them", random_answer_order=FALSE
)
```
