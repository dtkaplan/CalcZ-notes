...
```{r cdrill-7, echo=FALSE, results="markup"}
askMC(
  "Which of these is the R/mosaic notation for $\\equiv$?",
  "+`<- makeFun()`+", 
  "`makeFun()`" = "Almost right. `makeFun()` creates a function but doesn't give it a name.",
  "`<-`" = "Sorry. In R, this symbol means \"give a name to\" whatever is on the right side of the `<-`. The name being given is on the left side of `<-`."
)
```
