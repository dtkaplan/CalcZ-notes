...
askMC(
  ...
  "blue", 
  "neither", 
  "both" = "It can't be both. There's only one pattern-book function. When you scale the input, it becomes a \"basic modeling function\".",
...
askMC(
  ...
  "black",
  "+blue+" = "Right. The pattern-book function has an output of 1/2 when the output is zero. That's what the blue scale shows. ", 
  "neither", 
  "both" = "It can't be both. There's only one pattern-book function. When you scale the input, it becomes a \"basic modeling function\".",
  random_answer_order=FALSE
)
...
askMC(
  ...
  "black",
  "+blue+" = "The pattern-book sinusoid has a positive-going zero crossing at $x=0$. That's the blue scale.", 
  "neither", 
  "both" = "It can't be both. There's only one pattern-book function. When you scale the input, it becomes a \"basic modeling function\".",
  random_answer_order=FALSE
)
