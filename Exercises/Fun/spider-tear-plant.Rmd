...
knitr::include_graphics("www/800px-Mt._Eden_Panorama_December_2012.jpg")
```
...
```{r Maungawhau-plot, echo=FALSE, fig.cap="A combination surface and contour plot of the topography of Maungawhau."}
library(plotly)
