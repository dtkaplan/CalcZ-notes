...
slice_plot(g_1(t) ~ t, domain(t=c(0,200)), color = "dodgerblue",
...
```{r echo=FALSE}
slice_plot(0.5 *  g_1(t) + g2(t) ~ t, domain(t=c(0,200)) ) %>%
...
askMC(
  prompt = "Which  linear combination of $g_1(t)$ and $g_2(t)$ is shown in Graph (B)?",
    ...
    "$0.5\\,g_1(t) - 0.5\\, g_2(t)$" = "If this were so, the first gaussian hump would reach a value of 10 rather than the 20 seen in Graph (B).",
