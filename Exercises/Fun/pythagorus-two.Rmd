...
askMC(
  ...
  "$f(x) \\equiv a^2$" = "This wouldn't make sense. The output of $f()$ doesn't depend on its input.", 
  "+$f(x) \\equiv \\sqrt{x}$+",
...
message <- "This wouldn't make sense. The output of $f()$ doesn't depend on its input."
askMC(
