...
```{r daily-digital-04-sandbox3, exercise=TRUE, exercise.cap="Sandbox", warning=FALSE, exercise.setup="daily-digital-04-sandbox3-setup", exercise.eval=FALSE, exercise.lines=8, exercise.completion=FALSE, exercise.startover=TRUE, exercise.diagnostics=TRUE}
...
```{r daily-digital-04-Essay1, echo=FALSE}
etude2::etudeEssay(
  prompt = "Enter the numerical value of your best estimate of `k`."
)
```

```{r daily-digital-04-Essay2, echo=FALSE}
etude2::etudeEssay(
