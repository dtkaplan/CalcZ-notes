...
> The $\left\{\begin{array}{c}\mbox{derivative}\\\mbox{anti-derivative}\end{array}\right\}$
derivative of a $\left\{\begin{array}{c}\mbox{sigmoid}\\\mbox{hump}\end{array}\right\}$ is a $\left\{\begin{array}{c}\mbox{hump}\\\mbox{sigmoid}\end{array}\right\}$
