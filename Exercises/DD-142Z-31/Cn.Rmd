...
etude2::etudeQ("Consider $$f_A(x) \\equiv \\left\\{\\begin{array}{ccl}x^2 & \\mbox{for} & 0 \\leq x\\\\x&\\mbox{for}& x \\leq 0\\end{array} \\right.$$ How smooth is it?",
               "discontinuous",
               "+$C^0$+", 
               "$C^1$",
               "$C^2$",
...
etude2::etudeQ("Consider $$f_B(x) \\equiv \\left\\{\\begin{array}{ccl}x^3 & \\mbox{for} & 0 \\leq x\\\\0&\\mbox{for}& x \\leq 0\\end{array} \\right.$$ How smooth is it?",
               "discontinuous",
               "$C^0$", 
               "$C^1$",
               "+$C^2$+",
...
etude2::etudeQ("Consider $$f_C(x) \\equiv \\left\\{\\begin{array}{ccl}x^3 & \\mbox{for} & 0 \\leq x\\\\x^3 & \\mbox{for}& x \\leq 0\\end{array} \\right.$$ How smooth is it?",
               "discontinuous",
               "$C^0$", 
               "$C^1$",
               "$C^2$",
...
etude2::etudeQ("Consider $$f_D(x) \\equiv \\left\\{\\begin{array}{ccl}x^3 & \\mbox{for} & 0 \\leq x\\\\x^2&\\mbox{for}& x \\leq 0\\end{array} \\right.$$ How smooth is it?",
               "discontinuous",
               "$C^0$", 
               "+$C^1$+",
               "$C^2$",
...
etude2::etudeQ("Consider $$f_E(x) \\equiv \\left\\{\\begin{array}{ccl}x^3 & \\mbox{for} & 0 \\leq x\\\\-x^2 &\\mbox{for}& x \\leq 0\\end{array} \\right.$$ How smooth is it?",
               "discontinuous",
               "$C^0$", 
               "+$C^1$+",
               "$C^2$",
...
etude2::etudeQ("Consider $$f_F(x) \\equiv \\left\\{\\begin{array}{ccl}\\cos(x) & \\mbox{for} & 0 \\leq x\\\\0 &\\mbox{for}& x \\leq 0\\end{array} \\right.$$ How smooth is it?",
               "+discontinuous+",
               "$C^0$", 
               "$C^1$",
               "$C^2$",
...
etude2::etudeQ("Consider $$f_G(x) \\equiv \\left\\{\\begin{array}{ccl}\\sin(x) & \\mbox{for} & 0 \\leq x\\\\0 &\\mbox{for}& x \\leq 0\\end{array} \\right.$$ How smooth is it?",
               "discontinuous",
               "+$C^0$+", 
               "$C^1$",
               "$C^2$",
...
etude2::etudeQ("Consider $$f_H(x) \\equiv \\left\\{\\begin{array}{ccl}\\sin(x) & \\mbox{for} & 0 \\leq x\\\\x &\\mbox{for}& x \\leq 0\\end{array} \\right.$$ How smooth is it?",
               "discontinuous",
               "$C^0$", 
               "$C^1$",
               "+$C^2$+",
