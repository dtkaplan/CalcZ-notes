...
```{r daily-digital-38-sandbox2, exercise=TRUE, exercise.cap="Lens sandbox", exercise.eval=FALSE, exercise.lines=18, exercise.completion=FALSE, exercise.startover=TRUE, exercise.diagnostics=TRUE}
