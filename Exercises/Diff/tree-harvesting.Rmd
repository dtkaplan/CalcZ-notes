...
Back to the forest ... Here's a graph of the average-rate-of change function. The function has two inputs, but botany dictates that we can only be growing wood from the time the seedling is planted. So we'll set $t_A = 0$ and look at the corresponding *slice* of the function:
