...
In a sandbox, create this function and plot it. (Note: `rfun()` generates random functions in the same way you might by moving a pencil smoothly on a piece of paper. The `seed = 8427` effectively chooses which of infinitely many function is being generated. Different seeds give different functions. )
