...
askMC(r"(What sort of combination is $h_3(x) \equiv \sin(\cos(x))$?)","product", "+composition+", "neither", random_answer_order=FALSE)
```
...
askMC(r"(What sort of combination is $h_5(x) \equiv \sin(x) - \cos(x)$?)","product", "composition", "+neither+", random_answer_order=FALSE)
```
