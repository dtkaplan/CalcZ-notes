...
I"M HAVING TROUBLE GETTING THESE TO RENDER PROPERLY WITH MathJax

$$f_A(x) \equiv \left\{\begin{array}{ccl}{x^2} &  & 0\leq x\\ & \text{for} &  \\x& & x \leq 0\end{array} \right.$$


```{r cn1-1, echo=FALSE, results="markup"}
askMC(r"(Consider $$f_A(x) \equiv \left\{\begin{array}{ccl}{x^2} &  & 0\\ & \text{for} & \\ \leq x\\x& \text{for}& x \leq 0\end{array} \right.$$ How smooth is it?)",
               "discontinuous",
               "+$C^0$+", 
               "$C^1$",
               "$C^2$",
