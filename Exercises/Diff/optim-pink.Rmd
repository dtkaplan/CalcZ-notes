...
knitr::include_graphics("www/1200px-Fermat_Snellius.svg.png")
```
...
```{r daily-digital-36-sandbox2, exercise=TRUE, exercise.cap="Sandbox for light travel", exercise.eval=FALSE, exercise.lines=12, exercise.completion=FALSE, exercise.startover=TRUE, exercise.diagnostics=TRUE}
