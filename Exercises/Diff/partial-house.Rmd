...
etude::choose_one(
  prompt = "What would you expect about the quantity $\\partial P / \\partial A$?",
  choices = list(
...
etude::choose_one(
  prompt = "What would you expect about the quantity $\\partial P / \\partial N$?",
  choices = list(
    "It's positive" = "",
    "It's zero" = "",
...
etude::choose_one(
  prompt = "Suppose $\\partial P / \\partial r (184000,4,30) =$ $145.64.  What is the financial significance of the number $145.65??",
  choices = list(
