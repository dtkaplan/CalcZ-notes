...
```{r calculus-dog, echo=FALSE, out.width="90%", fig.align="center", fig.cap="Swimmer's optimal path to the ball consists of running $x$ meters along the shore, then swimming diagonally to the ball."}
