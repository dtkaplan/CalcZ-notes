...
In the following, three different functions are described. Your task is to write down the **dimension** of the input and the output for the function itself, and for the derivative of the function.
