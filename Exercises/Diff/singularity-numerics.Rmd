...
```{r daily-digital-30-Essay2, echo=FALSE}
etude2::etudeEssay(
  prompt = "Explain what the `options(digits=20)` statement is doing. You  can do some experiments by changing the 20 to something much smaller."
)
```
...
```{r daily-digital-30-Essay3, echo=FALSE}
etude2::etudeEssay(
  prompt = "Explain what about the output of the function $g()$ qualifies it for being numerically 'naughty' near $x=3$."
)
```
