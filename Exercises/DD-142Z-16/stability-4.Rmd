...
etude2::etudeQ("Consider the parameterized dynamical system $$x_{n+1} = \\alpha x_n + \\beta$$ What is the location of the fixed points in terms of the parameters $\\alpha$ and $\\beta$?",
...
etude2::etudeQ("In the system $$x_{n+1} = \\alpha x_n + \\beta$$ what is the condition for the fixed point to be stable?",
  "+$|\\alpha | < 1$+",
  "$|\\alpha| < |\\beta|$",
  "$|\\alpha| < \\beta$",
  "$|\\beta| < 1$"
