...
Short answer exercises are often arranged to give immediate feedback that goes beyond right-or-wrong. In other words, when an answer is incorrect, we try to tell you *why* it is incorrect to provide a hint to guide you to the correct answer. As a frivolous example:
