---
title: "Zooming in on Fixed points"
...
```{r echo=FALSE, out.width="75%", message=FALSE, fig.show="hold"}
...
etude2::etudeQ(
  "The fixed point in (C) shows a new pattern. It is stable in one direction and unstable in another. Which of these is correct?",
