...
so and error message will be generated. To figure out what's wrong, read the error message, check the variable names, and so on until you successfully make the plot.
:::
...
askMC(
  "D) Near age 20, the mortality of males is how much compared to females?",
