...
You are designing a pendulum for a planned joint NASA/ESA mission to Mars. From the orbital period and radius of Mars, its mass is known. From the mass and the observed diameter of the planet, gravitational acceleration at the surface is calculated as 3.721 m/s$^2$. According to Section \@ref(pendulum-dimensions), the period is $\text{Period} = 2 \pi \sqrt{\frac{\text{Gravity}}{\text{Length}}}$.
