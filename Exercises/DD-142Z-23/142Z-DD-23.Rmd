...
etude2::set_master_id("DD-23") # Add the DD number
etude2::etude_document_name("DD-142Z-23") # Add the DD number
...
<!--
## Force-balance equations DEFUNCT
...
```{r child="force-balance.Rmd"}
```

## Complex numbers

```{r child="complex-numbers.Rmd"}
```

## Friction

```{r child="friction.Rmd"}
```

## "Springs" and circuits 

```{r child="not-only-springs.Rmd"}
```

## Oscillations (rock-climbing edition)

```{r child="rock-pendulum.Rmd"}
```
