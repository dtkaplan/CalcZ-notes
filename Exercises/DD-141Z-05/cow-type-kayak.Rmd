...
Here is a code box which you can use to do scratch calculations. We've pre-filled it with the `amount.left()` function. Make a guess for n, try it out, then revise the guess until you get the output 10%.
