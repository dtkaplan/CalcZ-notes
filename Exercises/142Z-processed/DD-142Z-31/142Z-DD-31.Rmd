...
* Recognize that a Taylor polynomial always involves a center point $x_0$ and that the coefficients depend on the value chosen for the center point.
* Be able to use the $C^n$ scale for smoothness.
