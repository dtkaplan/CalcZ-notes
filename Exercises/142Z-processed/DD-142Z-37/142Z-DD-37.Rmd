...
* Generate objective functions based on interpolating data.

## Algorithms for optimization

```{r child="optimization-algorithmically.Rmd"}
```

## Follow the gradient!

```{r child="follow-the-gradient.Rmd"}
```

## Match the gradient!

```{r child="match-the-gradient.Rmd"}
```

## Objective functions from data

```{r child="QALY-data-change-budget.Rmd"}
```
