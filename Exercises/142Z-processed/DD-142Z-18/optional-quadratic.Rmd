...
$$ x_n = x_0\, \lambda^n \ \ \ \text{our ansatz}$$
...
$${\mathbf \Lambda}_1 = \left[\begin{array}{c} \lambda_1\\1 \end{array}\right]\ \ \ \text{and}\ \ \ {\mathbf \Lambda}_2 = \left[\begin{array}{c} \lambda_2\\1 \end{array}\right]$$

It happens that there is another formula that gives equivalent results so long as $b \neq 0$:

$${\mathbf \Lambda}_1 = \left[\begin{array}{c} b \\\lambda_1 - a \end{array}\right]\ \ \ \text{and}\ \ \ {\mathbf \Lambda}_2 = \left[\begin{array}{c} b\\\lambda_2-a\end{array}\right]$$
