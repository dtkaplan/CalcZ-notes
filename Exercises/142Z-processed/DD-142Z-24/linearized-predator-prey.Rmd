...
$$\dot{x} = \left.\partial_R g(R, F)\right|_\text{fp} x + \left.\partial_F g(R, F)\right|_\text{fp} y\\
\dot{y} = \left.\partial_R h(R, F)\right|_\text{fp} x + \left.\partial_F h(R, F)\right|_\text{fp} y\\$$ where $\cdot\left.\strut\right|_\text{fp}$ means to evaluate the derivative at the fixed point (fp) you found in the previous exercise.
...
askMC(
  "What is $\\left. \\partial_R g(R, F) \\right|_\\text{fp}$?",
  "+$r - \\beta F^\\star$+",
  "$\\mu - \\gamma R^\\star$",
  "$-\\beta F^\\star$",
  "$\\gamma R^\\star$"
...
askMC(
  "What is $\\left. \\partial_F g(R, F) \\right|_\\text{fp}$?",
  "$r - \\beta R^\\star$",
  "$\\mu + \\gamma R^\\star$",
  "+$-\\beta R^\\star$+",
  "$\\gamma F^\\star$"
...
askMC(
  "What is $\\left. \\partial_R h(R, F) \\right|_\\text{fp}$?",
  "$r - \\beta R^\\star$",
  "$\\mu - \\gamma F^\\star$",
  "$-\\beta F^\\star$",
  "+$\\gamma F^\\star$+"
...
$$\left[\begin{array}{cc}0 & -\beta/\gamma \\ -\gamma r/\beta & 0\end{array}\right]_\text{i}\ \ \ \ \ \ \left[\begin{array}{cc}0 & \beta\mu/\gamma \\ -\gamma r/\beta & 0\end{array}\right]_\text{ii}\ \ \ \ \ \ \left[\begin{array}{cc}0 & -\beta\mu/\gamma \\ \gamma r/\beta & 0\end{array}\right]_\text{iii}\ \ \ \ \ \ \left[\begin{array}{cc}r & -\beta\mu/\gamma \\ \gamma r/\beta & 0\end{array}\right]_\text{iv}$$
