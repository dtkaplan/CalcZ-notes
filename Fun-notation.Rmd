...
`r insert_calcZ_exercise(5.2, "LDNE", "Exercises/Fun/function-notation.Rmd")`

---------

`r insert_calcZ_exercise("5.3", "kZG5Fj", "Exercises/Fun/puppy-build-radio.Rmd")`


`r insert_calcZ_exercise("5.4", "aeOnO5", "Exercises/Fun/horse-sing-drawer.Rmd")`
