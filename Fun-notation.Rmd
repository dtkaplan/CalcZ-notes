...
`r insert_calcZ_exercise(5.1, "TKWEW", "Exercises/Fun/convention-drill.Rmd")`
...
`r insert_calcZ_exercise(5.7, "LDNE", exercise_file("02", "function-notation.Rmd"))`

---------

`r insert_calcZ_exercise("XX.XX", "kZG5Fj", "Exercises/Fun/puppy-build-radio.Rmd")`


`r insert_calcZ_exercise("XX.XX", "aeOnO5", "Exercises/Fun/horse-sing-drawer.Rmd")`
