...
We're going to be using a lot of functions in CalcZ. Some of these functions have ***proper names***, usually written using short sequences of letters: for instance the naked modeling functions $\sin()$, $\ln()$, $\exp()$. `r mark(600)`
