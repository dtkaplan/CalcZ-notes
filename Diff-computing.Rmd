...
Symbolic differentiation is the process of taking a formula and translating it to a new formula according to certain patterns or ***rules***. Each rule is ultimately derived from the definition of the slope function, but in use, the statement of each rule looks nothing like the slope function. This is potentially confusing, since it's easy to forget when using the rules where they come from. 
