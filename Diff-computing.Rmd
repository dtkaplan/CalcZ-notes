...
Figure \@ref(fig:slope-quick-check) provides a quick check of whether the function works and whether `h=0.1` is small enough. Since the tan curve runs right through the middle of the black curve, we have a good indication that $h = 0.001$ is just as good as $h = 0.00000000001$.
