...
::: {.takenote}
In modeling work, there's nothing wrong with an approximation so long as it is good enough for your purposes. We picked the value 0.1 for our definition of the slope function because it works very well with the naked modeling functions. Here, "very well" means you can't easily see in the graph any deviation compared the the exact derivative. `r mark(2190)`
