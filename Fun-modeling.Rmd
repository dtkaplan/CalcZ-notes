...
`r insert_calcZ_exercise("8.3", "YLWP1", "Exercises/Fun/flipping-1.Rmd")`

`r insert_calcZ_exercise(8.5, "YELXG", "Exercises/Fun/lamb-talk-gloves.Rmd")`

`r insert_calcZ_exercise(8.7, "VBWD", "Exercises/Fun/spirometer.Rmd")`

`r insert_calcZ_exercise(8.9, "vkwl4", "Exercises/Fun/chicken-choose-vase.Rmd")`

`r insert_calcZ_exercise(8.11, "asevss", "Exercises/Fun/cow-type-kayak.Rmd")`

`r insert_calcZ_exercise(8.13, "IELWV", "Exercises/Fun/hump-intro.Rmd")`

`r insert_calcZ_exercise(8.15, "CKSLE", "Exercises/Fun/sigmoid-intro.Rmd")`

`r insert_calcZ_exercise(8.17, "bllKR", "Exercises/Fun/sigmoid-bath.Rmd")`

`r insert_calcZ_exercise(8.19, "YLWP2", "Exercises/Fun/flipping-2.Rmd")`

`r insert_calcZ_exercise(8.21, "EKCIE", "Exercises/Fun/ebola-sigmoid.Rmd")`
