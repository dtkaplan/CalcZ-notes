...
```
<details>`r knitr::knit_child("Exercises/DD-141Z-04/exponential-bases.Rmd")`</details>
...
```
<details>`r knitr::knit_child("Exercises/Fun/maple-hit-saucer.Rmd")`</details>
...
```
<details>`r knitr::knit_child("Exercises/Fun/lamb-talk-gloves.Rmd")`</details>

```{exercise, name="spirometer"}
```
<details>`r knitr::knit_child("Exercises/Fun/spirometer.Rmd")`</details>
...
```
<details>`r knitr::knit_child("Exercises/Fun/sunset-in-LA.Rmd")`</details>
