...
```{exercise, name="exponential-bases"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/DD-141Z-04/exponential-bases.Rmd")`</details>
...
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/maple-hit-saucer.Rmd")`</details>
...
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/lamb-talk-gloves.Rmd")`</details>

```{exercise, name="spirometer"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/spirometer.Rmd")`</details>
...
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/hump-intro.Rmd")`</details>



```{exercise, name="sigmoid-intro"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/sigmoid-intro.Rmd")`</details>



```{exercise, name="sigmoid-bath"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/sigmoid-bath.Rmd")`</details>

```{exercise, name="ebola-sigmoid"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/ebola-sigmoid.Rmd")`</details>
...
```{exercise, daylength, name="sunset-in-LA"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/sunset-in-LA.Rmd")`</details>
