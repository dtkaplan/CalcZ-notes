...
For functions such as the sinusoid, flipping is not much use, since the flipped sinusoid curve is still a sinusoid, although with a shifted input. Similarly, a right-for-left flipped hump function has the same shape as the original. For the straight-line function, flipping of either sort accomplishes the same thing: changing the sign of the slope. 
...
<details>
<summary>`r ex.mark(8.36, "YLWP1", fname="Exercises/Fun/flipping-1.Rmd")` </summary>
`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/flipping-1.Rmd")`
</details>

-----

<details>
<summary>`r ex.mark(8.39, "YLWP2", fname="Exercises/Fun/flipping-2.Rmd")` </summary>
`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/flipping-2.Rmd")`
</details>
