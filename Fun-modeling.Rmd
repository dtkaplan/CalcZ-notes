...
`r insert_calcZ_exercise("XX.XX", "0rvpbu", "Exercises/Fun/kid-type-boat.Rmd")`
...
i. The point far from the baseline is located at $t_1 = 15 \text{sec}$ with a value ${\cal D} \approx 80^\circ\text{C}$. 
