...
Stated another way, the derivative $\partial_x f(x)$ has a positive slope just to the left of an argmin and a negative slope to the left of an argmax.  `r mark(2555)`
...
At the argmax $p^\star$ we have: $$p^\star \partial_p \text{Demand}(p^\star) + \text{Demand}(p^\star) = 0 \ \ \implies \ \ p^\star = - \frac{\text{Demand}(p^\star)}{\partial_p \text{Demand}(p^\star)}$$
