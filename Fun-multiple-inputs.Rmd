...
We can use ***linear combination*** and ***function multiplication*** to build up custom functions from the basic modeling functions. Similarly, linear combination and function multiplication provide ways to construct functions of multiple inputs. `r note(1400)` 
...
$$g_k(x, t) \equiv \sin(\frac{k \pi}{L} x) \ \sin(\frac{k \pi}{P}t)$$ Figure \@ref(fig:string-motion) shows a few snapshots of the 1.5 cycle string at different moments in time, and the motion of the linear combination.`r note(1410)` 
...
<details>
<summary>`r ex.mark(12.3, "NOAA", fname=exercise_file("01", "NOAA.Rmd"))` </summary>
`r MC_counter$reset()` `r knitr::knit_child(exercise_file("01", "NOAA.Rmd"))`
</details>

<details>
<summary>`r ex.mark(12.7, "EDKKW", fname="Exercises/Fun/pythagorus-two.Rmd")` </summary>
`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/pythagorus-two.Rmd")`
</details>

<details>
<summary>`r ex.mark(12.11, "EDKYV", fname="Exercises/Fun/bigger-two.Rmd")`
`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/bigger-two.Rmd")`
</details>
