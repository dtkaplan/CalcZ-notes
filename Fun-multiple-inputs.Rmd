...
```
<details>`r MC_counter$reset()` `r knitr::knit_child(exercise_file("01", "NOAA.Rmd"))`</details>


```{exercise, name="pythagorus-two"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/pythagorus-two.Rmd")`</details>

```{exercise, name="bigger-two"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/bigger-two.Rmd")`</details>
