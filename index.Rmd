...
Here are the steps. ADD MORE DETAILS

1. Install the R software. 
2. Install RStudio
3. In the R console, give this command:
```{r eval=FALSE}
source("https://dtkaplan.github.io/Znotes/install.R")
```

It will take some time for all the software to be installed. Be patient. 

INSTRUCTIONS ON STARTING THE SANDBOX AND DRILL APPS. WE REALLY NEED A VIDEO.

If using the console, start each session with `library(Zcalc)`
