...
::: {.todo}
This is currently just a jumble. Reorganize it!
:::
...
We want to relate the **period** (in T) of a pendulum to it's **length** and **mass**. **Gravity** also plays a role. For simplicity, we'll assume that the pendulum cable or rod is massless.
...
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Dimension/satellite-dimensions.Rmd")`</details>
...
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Dimension/dim-formulas.Rmd")`</details>

```{exercise, name="dim-params"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Dimension/dim-params.Rmd")`</details>


```{exercise, name="crow-mean-dress"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Dimension/crow-mean-dress.Rmd")`</details>
