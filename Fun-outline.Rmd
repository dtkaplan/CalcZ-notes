...
2. Basics of modeling functions
    a. NTI
        i. Highlight the difference between $e^x$ and $e^kx$ and explain why it's important to parameterize
    ...
    a. Outcomes
        ...
        i. Recognize that functions are a way of representing (storing) information
        i. Be able to use properly the basic nomenclature of functions
