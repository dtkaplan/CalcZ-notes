...
```{r neg-area, echo=FALSE, fig.cap="The $\\int_{-2}^3 g(t) dt$ covers subdomains where $g(t) > 0$ and where $g(t) < 0$. In those latter subdomains, the \"area\" is negative, and shown in light orange here."}
raw <- rfun( ~ t, seed=541)
...
`r insert_calcZ_exercise("30.02", "ady5Fh", "Exercises/Accum/monkey-light-stove.Rmd")`

`r insert_calcZ_exercise("30.04", "CCwWGB", "Exercises/Accum/tiger-tug-shoe.Rmd")`

`r insert_calcZ_exercise("30.06", "rk5PPK", "Exercises/Accum/seahorse-choose-canoe.Rmd")`

`r insert_calcZ_exercise("30.08", "9W6VB", "Exercises/Accum/euler-step.Rmd")`

`r insert_calcZ_exercise("30.10", "3IU9R", "Exercises/Accum/cumsum.Rmd")`

`r insert_calcZ_exercise("30.12", "ljCxcH", "Exercises/Accum/rhinosaurus-mute-tv.Rmd")`

`r insert_calcZ_exercise("30.14", "rfO0EG", "Exercises/Accum/falcon-hurt-pot.Rmd")`

ECONOMIST PICTURES

- https://www.economist.com/img/b/600/653/90/sites/default/files/images/print-edition/20210710_EUC776.png
```{r}
knitr::include_graphics("www/sputnik.png")
```

- https://www.economist.com/img/b/600/653/90/sites/default/files/images/print-edition/20210710_BRC783.png
```{r}
knitr::include_graphics("www/NHS.png")
```

- https://www.economist.com/img/b/600/653/90/sites/default/files/images/print-edition/20210710_EUC775.png
