...
$$\int^{7}_{3} e^{x^{2}} dx$$
<details>
<summary>Example Solution in R</summary>
```{r}
F <- antiD(exp(x^2)~x)
F(7) - F(3)
```
...
<details>
<summary>`r ex.mark(15.3, ACD4Z)`</summary>
...
Trying to get to Exercise \@ref(exr:ex-label).
...
<details>
<summary>`r ex.mark(15.4, "H2eu2")`</summary>
...
<details>
<summary>`r ex.mark(15.5, "H2l32")`</summary>
...
<details>
<summary>`r ex.mark(15.6, "H2l33")`</summary>
