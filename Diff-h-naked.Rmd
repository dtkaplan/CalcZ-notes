...
```
<details>`r knitr::knit_child("Exercises/Diff/low-low-rates.Rmd")`</details>

```{exercise, name="singularity-numerics"}
```
<details>`r knitr::knit_child("Exercises/Diff/singularity-numerics.Rmd")`</details>

```{exercise, name="NaN-numerics"}
```
<details>`r knitr::knit_child("Exercises/Diff/NaN-numerics.Rmd")`</details>
