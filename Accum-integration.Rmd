...
```{r galileo-accel, echo=FALSE, fig.cap="The acceleration, velocity, and position of the ball as a function of time in Galileo's Tower of Pisa experiment. The ball is released at time $t_0$." }
...
`r insert_calcZ_exercise("29.02", "DkoUjX", "Exercises/Accum/calf-know-painting.Rmd")`

`r insert_calcZ_exercise("29.04", "LCKEs","Exercises/Accum/three-perspectives.Rmd")`

`r insert_calcZ_exercise("29.06", "gDSeX","Exercises/Accum/first-fundamental-theorem.Rmd")`

`r insert_calcZ_exercise("29.08", "DKwksA","Exercises/Accum/heat-engine.Rmd")`

`r insert_calcZ_exercise("29.10", "ikgl","Exercises/Accum/wind-power.Rmd")`

`r insert_calcZ_exercise("29.12", "JKLes","Exercises/Accum/u-on-the-bottom.Rmd")`



An app.

`r insert_calcZ_exercise("29.14", "Hd5zsE", "Exercises/Accum/panda-tear-cotton.Rmd")`

`r insert_calcZ_exercise("29.16", "Rr2ds","Exercises/Accum/ups-and-downs.Rmd")`
