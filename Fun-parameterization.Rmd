...
```{exercise, name="scale-input-1"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/scale-input-1.Rmd")`</details>

```{exercise, name="scale-input-2"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/scale-input-2.Rmd")`</details>
