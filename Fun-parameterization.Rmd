...
To turn a naked modeling function into a ***basic modeling function*** all we do is use $h()$ to convert the input *before* applying the naked function.  `r mark(840)`
