...
gf_point(confirmed ~ day, 
  ...
  slice_plot(exp(x) ~ x, domain(x=c(0,15)), color="orange3", label_text = "exp(x)")
```
...
Name        |  Pattern-book form | Dressed for action
------------|-------------|------------------
...
`r insert_calcZ_exercise("XX.XX", "VcUetN", "Exercises/Fun/pig-make-table.Rmd")`
...
-----
`r insert_calcZ_exercise(7.17, "uKCIE", "Exercises/Fun/scale-input-1.Rmd")`

-----

`r insert_calcZ_exercise(7.10, "BLECL", "Exercises/Fun/scale-input-2.Rmd")`
...
`r insert_calcZ_exercise(7.21, "AVNOW", "Exercises/Fun/bumpy-road-1.Rmd")`

`r insert_calcZ_exercise(7.23, "FISHU", "Exercises/Fun/two-gaussians.Rmd")`
