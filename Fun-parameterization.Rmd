...
add_scale(exp(day) ~ day, domain(day=c(-1,11)), 1/0.19, 0.19*32) 
```
...
`r insert_calcZ_exercise(7.1, "MWLCS", "Exercises/Fun/fiducial-point.Rmd")`
...
`r insert_calcZ_exercise(7.2, "uKCIE", "Exercises/Fun/scale-input-1.Rmd")`

-----

`r insert_calcZ_exercise(7.3, "BLECL", "Exercises/Fun/scale-input-2.Rmd")`



`r insert_calcZ_exercise(7.4, "ILESX", "Exercises/Fun/cat-lend-futon.Rmd")`
...
`r insert_calcZ_exercise(7.5, "FKLEU", "Exercises/Fun/two-sines.Rmd")`
