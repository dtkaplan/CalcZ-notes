...
slice_plot(DH01(x) ~ x, domain(x=c(-0.02, 0.02)), npts=500,
  ...
  slice_plot(DH001(x) ~ x,
           color="darkgreen", npts=500, alpha=0.5, size=3, alpha=0.5) %>%
  slice_plot(DH0001(x) ~ x,
           color="blue", npts=500, alpha=0.5, size=2, alpha=0.5) 
```
...
`r insert_calcZ_exercise("XX.XX", "UNeewh", "Exercises/Diff/maple-sail-boat.Rmd")`
...
`r insert_calcZ_exercise("XX.XX", "jG4rie", "Exercises/Diff/camel-begin-piano.Rmd")`
