...
You've seen how various properties of a function---whether it is monotonic, how it slopes, whether it is concave up or down (or not at all), curvature, etc.---can be related to the first and second derivatives of the function. `r mark(2300)`

In this chapter, we'll elaborate on ***continuity***, one of the ideas introduced in Section \@ref(word-descriptions), and use the concept of continuity to characterize functions in a new way: their ***smoothness***. `r mark(2305)`
...
One of author Charles Dickens's famous characters, Mr. Macawber, described the relationship between income, expenditure, and happiness this way:
...
- $C^n$: Like $C^2$, but we're talk about the $n$^th^-derivative of $f(x)$ existing and being continuous.
