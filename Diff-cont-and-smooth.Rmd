...
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Diff/spider-tug-gloves.Rmd")`</details>

```{exercise, name="moose-hears-door"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Diff/moose-hears-door.Rmd")`</details>
