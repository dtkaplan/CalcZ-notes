...
```
<details>`r knitr::knit_child("Exercises/Diff/pine-lead-car.Rmd")`</details>

```{exercise, name="robin-row-boat"}
```
<details>`r knitr::knit_child("Exercises/Diff/robin-row-boat.Rmd")`</details>


```{exercise, name="deer-pitch-saw"}
```
<details>`r knitr::knit_child("Exercises/Diff/deer-pitch-saw.Rmd")`</details>
