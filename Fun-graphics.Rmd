...
```
<details>`r knitr::knit_child(exercise_file("03", "drawing.Rmd"))`</details>

```{exercise, daylength, name="length-of-day"}
```
<details>`rr knitr::knit_child("Exercises/Fun/length-of-day.Rmd")`</details>

```{exercise, daylength, name="dog-sees-red"}
```
<details>`rr knitr::knit_child("Exercises/Fun/dog-sees-red.Rmd")`</details>
