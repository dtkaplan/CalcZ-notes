...
::: {.workedexample}
Here is an ugly plot made of three layers, each layer displaying one of the pattern-book functions. When a `slice_plot()` is the first layer, the `domain()` must be given explicitly. You're welcome to do so in the later layers, but if you don't the original `domain()` will be passed down the pipeline.
