...
```{r echo=FALSE, out.width="70%", fig.align="center", fig.cap="A diagram showing a cubic function wich is concave up until a point of inflection and concave down thereafter."}
