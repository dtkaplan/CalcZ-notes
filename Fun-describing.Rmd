...
I'll illustrate these concepts using three pattern-book functions graphed in Figure \@ref(for-words).
...
Of these three pattern-book functions in Figure \@ref(fig:for-words), only the sinusoid has a local maximum, and, being periodic, it repeats that every cycle. The sinusoid similarly has a local minimum in every cycle..
