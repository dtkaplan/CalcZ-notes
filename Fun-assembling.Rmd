...
```{exercise, name="combining-hump-functions"}
```
<details>`rr knitr::knit_child("Exercises/Fun/combining-hump-functions.Rmd")`</details>
...
```
<details>`r knitr::knit_child("Exercises/Fun/rule-of-72.Rmd")`</details>
