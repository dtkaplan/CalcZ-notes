...
`r insert_calcZ_exercise(11.3, "JWUVA", "Exercises/Fun/combining-hump-funs.Rmd")`
...
`r insert_calcZ_exercise("XX.XX", "aA0ykt", "Exercises/Fun/eagle-dive-sofa.Rmd")`
...
`r insert_calcZ_exercise("XX.XX", "fmwTFj", "Exercises/Fun/horse-read-sofa.Rmd")`
...
For instance, the initial rise in popularity of the social media platform [Yik Yak](https://en.wikipedia.org/wiki/Yik_Yak) was exponential. Then popularity leveled off briefly like a sigmoid. Finally popularity collapsed to near zero and the company closed.
You could model this pattern by multiplying a sigmoid by an exponential, as in Figure \@ref(fig:yikyak).
...
`r insert_calcZ_exercise("XX.XX", "LPhyTb", "Exercises/Fun/maple-pitch-jacket.Rmd")`
...
`r insert_calcZ_exercise(11.19, "LDKKVA", "Exercises/Fun/arith-with-funs.Rmd")`

`r insert_calcZ_exercise(11.19, "MWDKVA", "Exercises/Fun/multiplying-functions.Rmd")`

`r insert_calcZ_exercise(11.23, "TWLC", "Exercises/Fun/available-health-care.Rmd")`

`r insert_calcZ_exercise(11.21, "AMBXI", "Exercises/Fun/compose-1.Rmd")`
