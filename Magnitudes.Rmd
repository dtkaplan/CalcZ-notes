...
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/cat-lend-futon.Rmd")`</details>

```{exercise, name="Boyles-data.Rmd"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child(exercise_file("06", "Boyles-data.Rmd"))`</details>
...
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/mag-blue.Rmd")`</details>
...
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/engine-magnitude-new.Rmd")`</details>
...
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/fish-walk-green.Rmd")`</details>


```{exercise,name="tiger-have-fork"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child(exercise_file("06", "tiger-have-fork.Rmd"))`</details>
...
```{exercise, name="count-the-digits"}
```
<details>`r MC_counter$reset()` `r knitr::knit_child("Exercises/Dimension/count-the-digits.Rmd")`</details>
