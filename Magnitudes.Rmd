...
You may have guessed that `digits()` is handy for computing differences in terms of orders of magnitude. Here's how:  `r note(1620)` 
...
Think about this in terms of the kinds of quantities that are the input and output to each function.  `r note(1630)` 
...
<details>
<summary>`r ex.mark(14.3, "ILESX", fname="Exercises/Dimension/cat-lend-futon.Rmd")`</summary>
`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/cat-lend-futon.Rmd")`
</details>

<details>
<summary>`r ex.mark(14.7, "RWESX", fname="Boyles-data.Rmd")`</summary>
`r MC_counter$reset()` `r knitr::knit_child(exercise_file("06", "Boyles-data.Rmd"))`
</details>

## Magnitude graphics

<details>
<summary>`r ex.mark(14.1, "ILXEG", fname="Exercises/Fun/mag-blue.Rmd")`</summary>
`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/mag-blue.Rmd")`
</details>
...
```
<details>
<summary>`r ex.mark(14.15, "EWLCI", fname="Exercises/Fun/engine-magnitude-new.Rmd")`</summary>
`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/engine-magnitude-new.Rmd")`
</details>


## Magnitude scales

Plotting the logarithm of a quantity gives a visual display of the magnitude of the quantity and labels the axis as that magnitude. A useful graphical technique is to label the axis with the original quantity, letting the position on the axis show the magnitude.  `r note(1640)` 
...
<details>
<summary>`r ex.mark(14.19, "TLEXE", fname="Exercises/Fun/fish-walk-green.Rmd")`</summary>
`r MC_counter$reset()` `r knitr::knit_child("Exercises/Fun/fish-walk-green.Rmd")`
</details>

<details>
<summary>`r ex.mark(14.23, "SELIX", fname="tiger-have-fork.Rmd")`</summary>
`r MC_counter$reset()` `r knitr::knit_child(exercise_file("06", "tiger-have-fork.Rmd"))`
</details>

## Fractional digits (optional) {#fractional-digits}

So far, we have the digit() function in a tabular form:  `r note(1650)` 
...
In everyday speech, 67 has two digits. The authors of *Chilias prima* sensibly didn't use the name "digit()" for the function. They chose something more abstract: "logarithm()". Nowadays, this function is named $\log_{10}()$. In R, the function is called `log10()`.  `r note(1660)` 
...
<details>
<summary>`r ex.mark(14.27, "TLCIX", fname="Dimension/count-the-digits.Rmd")`</summary>
`r MC_counter$reset()` `r knitr::knit_child("Exercises/Dimension/count-the-digits.Rmd")`
</details>
