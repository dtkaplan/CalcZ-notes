...
Prof. Schaubroeck used a very nice example to illustrate clearly two important points. 
    ...
    - How can you tell that F is the input to the function? That's what this syntax means: fun_name(input_name) \equiv ...
...
POSSIBLE in-class example. The A-110 fires depleted uranium rounds at a velocity of 1010 meters/sec. Find the energy contained in a 0.5 second burst and compare this to the energy content of 1kg of high-explosive. (Need to know firing rate and mass of rounds.)
