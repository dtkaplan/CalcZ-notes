...
There's a project in DailyDigitals/ 141 DD-35 with some narrative
:::


```{exercise, name="rooster-pink"}
```
<details>`r knitr::knit_child("Exercises/Diff/rooster-pink.Rmd")`</details>

```{exercise, name="rooster-violet"}
```
<details>`r knitr::knit_child("Exercises/Diff/rooster-violet.Rmd")`</details>



```{exercise, name="rooster-red"}
```
<details>`r knitr::knit_child("Exercises/Diff/rooster-red.Rmd")`</details>
...
```
<details>`r knitr::knit_child("Exercises/Diff/rooster-blue.Rmd")`</details>
