...
So the form $a + bx + cx^2$ is easily capable of representing four of the ***eight simple shapes***. What about the other four? You can see how this is done by looking at the graphs of the parabolas with $0 < c$ and with $c < 0$, as in Figure \@ref(fig:four-shapes).
