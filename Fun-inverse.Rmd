...
`r insert_calcZ_exercise(10.2, "IWLDN1", exercise_file("02", "invertible.Rmd"))`
-->


`r insert_calcZ_exercise(10.2, "IWLDN1", "Exercises/Fun/inverse-flip-1.Rmd")`

-----

`r insert_calcZ_exercise(10.3, "RDWKW", exercise_file("02", "exponentials.Rmd"))`
