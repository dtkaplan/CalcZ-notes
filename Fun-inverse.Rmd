...
$$\mbox{miles_plowed}(x) \equiv 7 \ \text{mph} \times 24 \ \text{hours-per-day}\times x\ \text{plows}$$
...
Now let's write the problem using math notation rather than a table. We're looking for a value of $x$ such that $$\mbox{miles_plowed}(x) = 400$$ This is an ***equation*** as opposed to a ***function definition***. We write equations with $=$ and definitions with $\equiv$. The point of writing equations is often to signal to us that the task is to "solve for $x$." 
