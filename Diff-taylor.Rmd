...
```{r taylor-exp-4, echo=FALSE, class.source="code-hide", fig.cap="The error from a 4th-order Taylor polynomial approximation to $e^x$ around $x=0$.", out.width="50%", fig.show="hold"}
