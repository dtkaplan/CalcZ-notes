...
```{r calcul-des-differences, echo=FALSE, out.width="70%", fig.cap="From the start of the first calculus textbook, by le marquis de l'Hôpital, 1696."}
...
`r insert_calcZ_exercise("24.01", "xdkw", "Exercises/Diff/gradient-field-orange.Rmd")`

`r insert_calcZ_exercise("24.02", "9iowVB", "Exercises/Diff/partial-purple.Rmd")`

`r insert_calcZ_exercise("24.04", "qdkw", "Exercises/Diff/partial-tan.Rmd")`

`r insert_calcZ_exercise("24.06", "uekses", "Exercises/Diff/partial-doctor.Rmd")`


`r insert_calcZ_exercise("24.07", "RbuhMy", "Exercises/Diff/child-hide-lamp.Rmd")`

`r insert_calcZ_exercise("24.08", "lkwciw", "Exercises/Diff/gradient-field-blue.Rmd")`


`r insert_calcZ_exercise("24.10", "wkd83", "Exercises/Diff/gradient-field-red.Rmd")`

`r insert_calcZ_exercise("24.12", "tPsfoR", "Exercises/Diff/boy-iron-dish.Rmd")`



`r insert_calcZ_exercise("24.14", "vkdlw", "Exercises/Diff/partial-house.Rmd")`

`r insert_calcZ_exercise("24.16", "72ldw", "Exercises/Diff/spider-blow-lamp.Rmd")`


`r insert_calcZ_exercise("24.18", "oekse", "Exercises/Diff/grass-grows-red.Rmd")`


`r insert_calcZ_exercise("24.20", "ZQlUv4", "Exercises/Diff/shark-bite-sheet.Rmd")`
