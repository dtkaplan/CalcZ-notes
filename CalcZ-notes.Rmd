...
Each conversion function can be written in the form $h(x) \equiv m (x - x_0)$. Of course, if you multiply the $m$ through both terms in parentheses, you get $h(x) = m x - m x_0 = mx + b$ if we define $b\equiv m x_0$. So the conversion function is simply the straight-line function.
...
::: {.workedexample}
There is a parameterization of the straight-line function that is handy for finding parameters of a function from a graph.
...
Pick out the characteristic inputs on the curve. E.g. start and doubling times: where outputs will be 1 and 2
