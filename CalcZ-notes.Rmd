...
An oftimes better approach is to compose the polynomial with a curved but monotonic function, such as a logarithm.
...
$$h_3(x, y) \equiv b_0 + b_x\, x + b_y\, y + b_{xy}\,x\, y + \underbrace{b_{yy}\, y^2}_\mbox{quadratic in y}$$
