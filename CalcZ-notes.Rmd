...
2. Basics of modeling functions
    a. NTI
        i. Highlight the difference between $e^x$ and $e^kx$ and explain why it's important
        I. Explain that the $C$ in $Ce^{kt}$ scales the output and the $k$ scales the input
    a. Lecture Topics
...
3. Functions as I/O and Notational Structure of functions (R<>Math)
    ...
    a. Topics
        ...
        i. Introduce Multi-input functions notation
    ...
    a. Outcomes
        ...
        i. Be able to read contour plots and function tables showing inputs and outputs
