...
The water is cooling continuously. Sometimes we'll be interested in the rate of change at a given instant $t_0$. It's straightforward to make out what the instantaneous rate of change will be on a graph: the slope of the line tangent to the curve at $t_0$, as in Figure \@ref(fig:tangent-line-exp).  `r mark(1150)`
...
For an in-the-world: Calculate the slope function of the naked sigmoidal function. What is its value at x=0. Do some other functions as well.

Also, some where we change the 0.1 to something smaller.

Maybe a "What is small?"

<!--
<details>
<summary>Exercise: This exercise is misplaced and unfinished.</summary>
`r MC_counter$reset()` `r knitr::knit_child("Exercises/Diff/tree-harvesting.Rmd")`
</details>
