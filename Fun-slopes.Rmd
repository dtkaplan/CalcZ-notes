...
- **Reading parameters from a graph**: You learned several ways to do this which are all equivalent. Maybe the easiest is t roead the y-intercept off the graph. That's $b$. Then choose some non-zero $x_1$ and read off from the graph the value of $f(x_1)$. The slope is simply $$\frac{f(x_1) - b}{x_1}$$
...
`r insert_calcZ_exercise(9.4, "KEWIX", "Exercises/Fun/snail-tear-blanket.Rmd")`


-----


`r insert_calcZ_exercise(9.5, "WRWIX", "Exercises/Fun/goat-dive-saucer.Rmd")`


-----


`r insert_calcZ_exercise(9.6, "YQCLE", "Exercises/Fun/chicken-show-map.Rmd")`


-----


`r insert_calcZ_exercise(9.7, "rTSX3", "Exercises/Fun/eagle-bring-car.Rmd")`


-----


`r insert_calcZ_exercise(9.8, "URIMX", "Exercises/Fun/pig-look-rug.Rmd")`

-----

`r insert_calcZ_exercise(9.9, "RDWKW", "Exercises/Fun/exponentials.Rmd")`
...
P %>%
  ...
  gf_abline(intercept=0, slope=40, color="orange3") %>%
...
`r insert_calcZ_exercise(9.10, "HRTIX", "Exercises/Fun/lion-find-bowl.Rmd")`
...
`r insert_calcZ_exercise(9.12, "CUXLR", "Exercises/Fun/slope-web-1.Rmd")`

-----

`r insert_calcZ_exercise("9.13", "MW03ay", "Exercises/Fun/lamb-put-bulb.Rmd")`
