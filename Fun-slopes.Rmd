...
- **Reading parameters from a graph**: You learned several ways to do this which are all equivalent. Maybe the easiest is to read the y-intercept off the graph. That's $b$. Then choose some non-zero $x_1$ and read off from the graph the value of $f(x_1)$. The slope is simply $$\frac{f(x_1) - b}{x_1}$$
