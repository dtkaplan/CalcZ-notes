...
::: {.objectives}
```{r echo=FALSE, results="asis"}
state_objective("Fun-3a1", "Understand a logarithm (base-10) as signifying the magnitude of a number by the digit count.") state_objective("Fun-magnitude", "See $\log_2()$ and $\log_{10}()$ as counting digits in base-2 and -10 respectively.")
```
:::
