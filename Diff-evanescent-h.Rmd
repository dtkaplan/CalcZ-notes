...
\sin(x)\ \ \ \longrightarrow\ \ \ \sin\left(\strut2 \pi (x-x_0)/P\right)\\
\exp(x)\ \ \ \longrightarrow\ \ \ \exp(k x)\\
x^2 \ \ \ \longrightarrow\ \ \ (mx + b)^2\\
1/x \ \ \ \longrightarrow\ \ \ 1/(mx + b)\\
...
i. $\partial_x \pnorm\left(\frac{x-mn}{sd}\right) = \frac{1}{sd}\, \pnorm\left(\frac{x-mn}{sd}\right)$
ii. $\partial_x \pnorm(x, mn, sd) = \dnorm(x, mn, sd)$
